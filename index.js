...
bot.on("message", message => {
    if (message.channel.id === config.botChannel) { 
        ...
        if (command === "gen") {
            if (generated.has(message.author.id)) {
                message.channel.send(
                    "You have a Cool Down of 2 minutes! - " +
                    message.author
                );
            } else {
                ...
                const embed = {
                    ...
                    footer: {
                        icon_url:
                            "https://cdn.discordapp.com/avatars/917592229802049566/126b689f01a2b056619bc86a4d946d67.png?size=4096",
                        text: "Developed by Fらんｄｙ#0001"
                    },
                    thumbnail: {
                        url:
                            "https://cdn.discordapp.com/avatars/917592229802049566/126b689f01a2b056619bc86a4d946d67.png?size=4096"
                    ...
                    author: {
                        name: "Imaguy Acccount Generator Bot",
                        url: "https://discord.gg/n2wnte4uKY",
                        ...
                        if (position != -1) {
                            ...
                            fs.writeFile(filePath, data, function (err) {
                                const embed = {
                                    ...
                                    author: {
                                        name: "Imaguy Account Generator Bot",
                                        url: "https://discord.gg/n2wnte4uKY",
                                        icon_url: bot.displayAvatarURL
                                    },
                                    fields: []
            ...
            if (command === "help") {
                ...
                const embed = {
                    color: 0xff033d,
                    title: 'Imaguy Account Generator Bot',
                    url: 'https://discord.gg/n2wnte4uKY',
                    author: {
                        name: 'Command list',
                        //icon_url: 'https://cdn.discordapp.com/avatars/917592229802049566/126b689f01a2b056619bc86a4d946d67.png?size=4096',
                        url: 'https://discord.gg/n2wnte4uKY',
                    },
                    description: '**This is a List of all Commands**',
                    thumbnail: {
                        url: 'https://cdn.discordapp.com/avatars/917592229802049566/126b689f01a2b056619bc86a4d946d67.png?size=4096',
                    },
                    fields: [
                        {
        ...
        if (command === "restock") {
            ...
            message.channel.send("<@&957094549216432198> " + args[0] + " has been restocked by " + "<@" + message.author.id +">");
            }
        }
    }
});
